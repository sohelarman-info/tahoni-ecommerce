        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                        ...
                        <div class="account-form form-style">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <label for="password">Renenber Password</label>
                                </div>
                    ...
                    <div class="text-center">
                        <a class="btn btn-primary" href="{{ route('LoginWithGithub') }}"> <i class="fa fa-github"></i> Login With GitHub Account </a>
                    </div>
                    <br>
                    <div class="text-center">
                        <a class="btn btn-primary" href="{{ route('LoginWithGoogle') }}"> <i class="fa fa-google-plus"></i> Login With Google Account </a>
                    </div>
                </div>
            </div>
        </div>
