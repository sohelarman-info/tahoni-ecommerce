                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body d-flex">
                                ...
                                <div class="product-single-content w-50">
                                    ...
                                    <ul class="cetagory">
                                        <li>Categories:</li>
                                        <li><a href="#">{{ $item->category->category_name ?? 'N/A' }}</a></li><br>
                                        <li>Sub Category:</li>
                                        <li><a href="#">{{ $item->subcategory->subcategory_name ?? 'N/A' }}</a></li>
                                    </ul>
                                    <ul class="socil-icon">
                                        <li>Share :</li>
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u={{ route('SingleProduct',$item->slug) }}"><i class="fa fa-facebook"></i></a></li>
